...
<body>
	<!-- Page heading start -->
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Color Code Entry
			Form</h2>
			...
			<div class="col-md-12">
					...
					<div class="widget-content">
						<div class="padd">
							...
							<form:form cssClass="form-horizontal" method="POST" name="reg"
								id="colorCodeForm" class="form-horizontal"
								modelAttribute="command" accept-charset="UTF-8"
								action="${pageContext.request.contextPath}/saveColorCode">
								
								<form:input type="hidden" path="id" value="${colorCode.id}"
								...
								<div class="form-group">
									<label class="col-lg-2 control-label">Color Name <span class="red">*</span>: </label>
									<div class="col-lg-5">
										<form:input id="name" path="name"
											value="${colorCode.name}" class="form-control" />
									</div>
								</div>

								<div class="form-group">
									<label class="col-lg-2 control-label">Hexa Code <span class="red">*</span>: </label>
									<div class="col-lg-5">
										<form:input id="hexaCode" path="hexaCode"
											value="${colorCode.hexaCode}" class="form-control" />
									</div>
								</div>
									...
									<div class="col-lg-5">
										<textarea id="remarks" class="form-control" name="remarks"
											rows="4" type="textarea"><c:out
												value="${colorCode.remarks}" /></textarea>
									</div>
								</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">Color Code Details</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="fa fa-times"></i></a>
								</div>
										...
										<table class="table table-striped table-bordered table-hover"
											...
											<thead>
												<tr style="background-color: #5cb85c; color: white">
													...
													<th class="text-center">Hexa Code</th>
											...
											<tbody>
												<c:forEach items="${colorCodeList}" var="colorCode" varStatus="slNo">
													<tr>
														<td class="text-center"><c:out value="${slNo.count}" /></td>
														<td class="text-center"><c:out value="${colorCode.name}" /></td>
														<td class="text-center" style="color:${colorCode.hexaCode};"><c:out value="${colorCode.hexaCode}" /></td>
														<td class="text-center"><c:out value="${colorCode.remarks}" /></td>
														<td class="text-center">
															<a class="btn btn-primary custom" href="editColorCode?id=${colorCode.id}">Edit</a>
														</td>
													</tr>
												</c:forEach>
	...
	<script>
		$(function() {
			...
			$("form[name='reg']").validate({
				...
				messages : {
					name : "Please enter Color Code",
					hexaCode : "Please enter Hexa Code"
				},
