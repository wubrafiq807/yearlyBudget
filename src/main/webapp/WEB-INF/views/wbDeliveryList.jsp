...
<body>
	...
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Without Budget Delivery List</h2>
					...
					<div class="col-md-12">
						...
						<div class="widget">
							...
							<div class="widget-head">
								<div class="pull-left">Without Budget Delivery List Details</div>&nbsp;&nbsp;&nbsp;&nbsp;
										...
										<table class="table table-bordered table-hover" id="table1">
											<thead>
												<tr style="background-color: #428bca; color: white">
													...
													<th class="text-center">Budget Year</th>
											...
											<tbody>
												<c:forEach items="${deliveryList}" var="delivery"
													...
													<tr>
														...
														<td class="text-center">${delivery.fiscalYearDlv.name}</td>
														<td class="text-center">${delivery.point.name} - (${delivery.point.keyword})</td>
														<td class="text-center">${delivery.goodsType.name}</td>
														<td class="text-center">${delivery.fiscalYearBgt.name}</td>
														<td class="text-center">${delivery.budgetSource.name}</td>
														<td class="text-center">${delivery.budgetCode.name}</td>
														...
														<td class="text-center">${delivery.modifiedBy}</td>
														<td class="text-center"><fmt:formatDate value="${delivery.modifiedDate}" pattern="dd-MM-yyyy HH:MM:ss a"/></td>
														<td class="text-center">${delivery.remarks}</td>
														<td class="text-center">
															<a class="btn btn-primary custom" href="editDelivery?id=${delivery.id}">Edit</a>
														</td>
													</tr>
												</c:forEach>
