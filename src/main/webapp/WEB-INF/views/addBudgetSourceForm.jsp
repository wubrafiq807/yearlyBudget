...
<body>
	<!-- Page heading start -->
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Budget Source Entry
			Form</h2>
			...
			<div class="col-md-12">
					...
					<div class="widget-content">
						<div class="padd">
							...
							<form:form cssClass="form-horizontal" method="POST" name="reg"
								id="budgetSourceForm" class="form-horizontal"
								modelAttribute="command" accept-charset="UTF-8"
								action="${pageContext.request.contextPath}/saveBudgetSource">
								
								<form:input type="hidden" path="id" value="${budgetSource.id}"
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
										<form:input id="name" path="name"
											value="${budgetSource.name}" class="form-control" />
									</div>
								</div>
									...
									<div class="col-lg-5">
										<textarea id="remarks" class="form-control" name="remarks"
											rows="4" type="textarea"><c:out
												value="${budgetSource.remarks}" /></textarea>
									</div>
								</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">Budget Source Details</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="fa fa-times"></i></a>
								</div>
							...
							<div class="widget-content">
								<div class="table-responsive">
									<c:if test="${!empty budgetSourceList}">
										<table class="table table-striped table-bordered table-hover"
											...
											<tbody>
												<c:forEach items="${budgetSourceList}" var="budgetSource" varStatus="slNo">
													<tr>
														<td class="text-center"><c:out value="${slNo.count}" /></td>
														<td class="text-center"><c:out value="${budgetSource.name}" /></td>
														<td class="text-center"><c:out value="${budgetSource.remarks}" /></td>
														<td class="text-center">
															<a class="btn btn-primary custom" href="editBudgetSource?id=${budgetSource.id}">Edit</a>
														</td>
													</tr>
												</c:forEach>
