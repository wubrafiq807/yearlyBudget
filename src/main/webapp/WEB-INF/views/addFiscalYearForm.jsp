					...
					<div class="widget-content">
						<div class="padd">
							...
							<form:form cssClass="form-horizontal" method="POST" name="reg"
								...
								<form:input type="hidden" path="id" value="${fiscalYear.id}"
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
										<form:input id="name" path="name"
											value="${fiscalYear.name}" class="form-control" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
										<form:input id="fromYear" path="fromYear"
											value="${fiscalYear.fromYear}" class="form-control" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
										<form:input id="toYear" path="toYear"
											value="${fiscalYear.toYear}" class="form-control" />
									</div>
								</div>
									...
									<div class="col-lg-5">
										<textarea id="remarks" class="form-control" name="remarks"
											rows="4" type="textarea"><c:out
												value="${fiscalYear.remarks}" /></textarea>
									</div>
								</div>
