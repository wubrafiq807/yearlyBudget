...
<body>
	<!-- Page heading start -->
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Point Type Entry
			Form</h2>
			...
			<div class="col-md-12">
					...
					<div class="widget-content">
						<div class="padd">
							...
							<form:form cssClass="form-horizontal" method="POST" name="reg"
								...
								action="${pageContext.request.contextPath}/savePointType">
								
								<form:input type="hidden" path="id" value="${pointType.id}"
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
										<form:input id="name" path="name"
											value="${pointType.name}" class="form-control" />
									</div>
								</div>
									...
									<div class="col-lg-5">
										<textarea id="remarks" class="form-control" name="remarks"
											rows="4" type="textarea"><c:out
												value="${pointType.remarks}" /></textarea>
									</div>
								</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">Point Type Details</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="fa fa-times"></i></a>
								</div>
								...
								<div class="table-responsive">
									<c:if test="${!empty pointTypeList}">
										<table class="table table-striped table-bordered table-hover"
											...
											<tbody>
												<c:forEach items="${pointTypeList}" var="pointType" varStatus="slNo">
													<tr>
														<td class="text-center"><c:out value="${slNo.count}" /></td>
														<td class="text-center"><c:out value="${pointType.name}" /></td>
														<td class="text-center"><c:out value="${pointType.remarks}" /></td>
														<td class="text-center">
															<a class="btn btn-primary custom" href="editPointType?id=${pointType.id}">Edit</a>
														</td>
													</tr>
												</c:forEach>
