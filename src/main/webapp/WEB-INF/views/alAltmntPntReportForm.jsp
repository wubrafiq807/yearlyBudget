...
<body>
	<!-- Page heading start -->
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">All Allotment Team Leader &amp; Point Wise Report</h2>
				...
				<div class="widget wgreen">
					...
					<div class="widget-content">
						<div class="padd">
							...
							<!-- Form starts.  -->
							<form:form cssClass="form-horizontal" method="GET" name="reg"
								id="pointTypeForm" class="form-horizontal"
								modelAttribute="command" accept-charset="UTF-8"
								action="${pageContext.request.contextPath}/downLoadAllAltByTeamLdAndPoint">
									...
									<div class="col-lg-5">
										<form:select path="pointId" id="pointId" class="form-control basic-single-select2">			
											...
											<c:forEach items="${pointList}" var="point">
												<form:option value="${point.id}">${point.name}</form:option>
											</c:forEach>
										</form:select>
									</div>
								</div> 
	...
	$(function() {
		...
		$("form[name='reg']").validate({
			...
			messages : {
				...
				teamLeaderId : "Please Select Team Leader"
			},
