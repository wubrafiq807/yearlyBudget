...
<body>
	<!-- Page heading start -->
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Goods Type Entry
			Form</h2>
			...
			<div class="col-md-12">
					...
					<div class="widget-content">
						<div class="padd">
							...
							<form:form cssClass="form-horizontal" method="POST" name="reg"
								id="goodsTypeForm" class="form-horizontal"
								modelAttribute="command" accept-charset="UTF-8"
								action="${pageContext.request.contextPath}/saveGoodsType">
								
								<form:input type="hidden" path="id" value="${goodsType.id}"
								...
								<div class="form-group">
									<label class="col-lg-2 control-label">Type of Goods <span class="red">*</span>: </label>
									<div class="col-lg-5">
										<form:input id="name" path="name"
											value="${goodsType.name}" class="form-control" />
									</div>
								</div>
									...
									<div class="col-lg-5">
										<textarea id="remarks" class="form-control" name="remarks"
											rows="4" type="textarea"><c:out
												value="${goodsType.remarks}" /></textarea>
									</div>
								</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">Goods Type Details</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="fa fa-times"></i></a>
								</div>
								...
								<div class="table-responsive">
									<c:if test="${!empty goodsTypeList}">
										<table class="table table-striped table-bordered table-hover"
											...
											<tbody>
												<c:forEach items="${goodsTypeList}" var="goodsType" varStatus="slNo">
													<tr>
														<td class="text-center"><c:out value="${slNo.count}" /></td>
														<td class="text-center"><c:out value="${goodsType.name}" /></td>
														<td class="text-center"><c:out value="${goodsType.remarks}" /></td>
														<td class="text-center">
															<a class="btn btn-primary custom" href="editGoodsType?id=${goodsType.id}">Edit</a>
														</td>
													</tr>
												</c:forEach>
	...
	<script>
		$(function() {
			...
			$("form[name='reg']").validate({
				...
				messages : {
					name : "Please enter Type of Goods"
				},
